...
This project provides two operating modes:
...
1. Test manually on one Windows host
2. Validate the report pipeline
3. Import the artifact into Velociraptor
4. Run it on one Windows lab endpoint
5. Review uploads and returned files
6. Only then scale to more endpoints
7. Only after that move into offline collector workflows
...
- Does not replace detailed manual forensic analysis
- Intended for fast triage, reporting, and evidence packaging
